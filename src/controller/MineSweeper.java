...
public class MineSweeper {
	...
	public MineSweeper(double x, double y, double heading, NeuralNet net) throws Exception {
		if (x < Parameters.BORDER_PADDING || x >= Parameters.BORDER_PADDING + Parameters.BOARD_WIDTH
			...
			throw new Exception("Initial coordinates of minesweeper are out of bounds! (" + x + ", " + y + "); (" + Parameters.BORDER_PADDING + "-" + (Parameters.BORDER_PADDING + Parameters.BOARD_WIDTH) + ", " + Parameters.BORDER_PADDING + "-" + (Parameters.BORDER_PADDING + Parameters.BOARD_HEIGHT) + ")");
		}
	...
	public void doTurn () {
		...
		x = clampWrap(x + (((Math.sin(Math.toRadians(heading)) * forwardSpeed))), Parameters.BORDER_PADDING, Parameters.BORDER_PADDING + Parameters.BOARD_WIDTH);
		y = clampWrap(y + (((Math.cos(Math.toRadians(heading)) * forwardSpeed))), Parameters.BORDER_PADDING, Parameters.BORDER_PADDING + Parameters.BOARD_HEIGHT);
